...
export async function POST(req) {
  ...
  try {
    ...
    console.log("🔍 Creating OTP approval with flowId:", flowId);
    console.log("🔍 FlowId type:", typeof flowId, "Length:", flowId?.length);
    ...
    console.log("🔍 OTP Approval created:", approval);
